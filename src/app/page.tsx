    ...
    <main className="flex min-h-screen flex-col p-10">
      <div className="z-10 w-full max-w-5xl justify-center font-mono flex flex-col align-top">
        ...
        <div className="flex flex-row">
          <h3 className="font-Knewave text-lg -rotate-[25deg]">Step 1 - Choose Your Design</h3>
          <h3 className="font-Knewave text-lg -rotate-[25deg]">Step 2 - Choose Your Board Style</h3>
          <h3 className="font-Knewave text-lg -rotate-[25deg]">Step 3 - Pay and Ship!</h3>
        </div>
      </div>
      <div>
